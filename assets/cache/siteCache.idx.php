...
// Run the main code
include($modx->config[\'base_path\'].\'assets/plugins/managermanager/mm.inc.php\');';$p['ManagerManagerProps']='&remove_deprecated_tv_types_pref=Remove deprecated TV types;list;yes,no;yes &config_chunk=Configuration Chunk;text;mm_rules ';$p['TransAlias']='require MODX_BASE_PATH.\'assets/plugins/transalias/plugin.transalias.php\';';$p['TransAliasProps']='&table_name=Trans table;list;common,russian,dutch,german,czech,utf8,utf8lowercase;utf8lowercase &char_restrict=Restrict alias to;list;lowercase alphanumeric,alphanumeric,legal characters;legal characters &remove_periods=Remove Periods;list;Yes,No;No &word_separator=Word Separator;list;dash,underscore,none;dash &override_tv=Override TV name;string; ';$p['FileSource']='require MODX_BASE_PATH.\'assets/plugins/filesource/plugin.filesource.php\';';$e = &$this->pluginEvent;$e['OnBeforePluginFormSave']=array('ElementsInTree','TransAlias','Quick Manager+','Forgot Manager Login','FileSource','CodeMirror','ElementsInTree','ManagerManager','TinyMCE4','Forgot Manager Login','TransAlias','CodeMirror','Quick Manager+','ManagerManager','FileSource','TinyMCE4');$e['OnBeforeSnipFormSave']=array('CodeMirror','Quick Manager+','ManagerManager','FileSource','TinyMCE4','ElementsInTree','TransAlias','Quick Manager+','Forgot Manager Login','FileSource','CodeMirror','ElementsInTree','ManagerManager','TinyMCE4','Forgot Manager Login','TransAlias');$e['OnInterfaceSettingsRender']=array('TinyMCE Rich Text Editor','TinyMCE Rich Text Editor');$e['OnParseDocument']=array('PHx','PHx');$e['OnPluginFormPrerender']=array('TinyMCE4','Forgot Manager Login','TransAlias','CodeMirror','Quick Manager+','ManagerManager','FileSource','TinyMCE4','ElementsInTree','TransAlias','Quick Manager+','Forgot Manager Login','FileSource','CodeMirror','ElementsInTree','ManagerManager');$e['OnPluginFormRender']=array('CodeMirror','Quick Manager+','ManagerManager','FileSource','TinyMCE4','ElementsInTree','TransAlias','Quick Manager+','Forgot Manager Login','FileSource','CodeMirror','ElementsInTree','ManagerManager','TinyMCE4','Forgot Manager Login','TransAlias');$e['OnRichTextEditorInit']=array('TinyMCE Rich Text Editor','TinyMCE Rich Text Editor');$e['OnRichTextEditorRegister']=array('TinyMCE Rich Text Editor','TinyMCE Rich Text Editor');$e['OnSnipFormPrerender']=array('FileSource','CodeMirror','ElementsInTree','ManagerManager','TinyMCE4','Forgot Manager Login','TransAlias','CodeMirror','Quick Manager+','ManagerManager','FileSource','TinyMCE4','ElementsInTree','TransAlias','Quick Manager+','Forgot Manager Login');$e['OnSnipFormRender']=array('TinyMCE4','Forgot Manager Login','TransAlias','CodeMirror','Quick Manager+','ManagerManager','FileSource','TinyMCE4','ElementsInTree','TransAlias','Quick Manager+','Forgot Manager Login','FileSource','CodeMirror','ElementsInTree','ManagerManager');$e['OnWebPagePrerender']=array('Search Highlight','Search Highlight');